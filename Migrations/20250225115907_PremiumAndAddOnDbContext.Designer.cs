...
namespace SkillShare.Migrations
{
    ...
    [Migration("20250225115907_PremiumAndAddOnDbContext")]
    partial class PremiumAndAddOnDbContext
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkillShare.Domain.Entities.AddOn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SkillShare.Domain.Entities.PremiumProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SkillShare.Domain.Entities.UserAddOn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SkillShare.Domain.Entities.Schedule", b =>
                {
                    ...
                    b.OwnsOne("SkillShare.Domain.ValueObjects.TimeSlot", "TimeSlot", b1 =>
                        {
            ...
            modelBuilder.Entity("SkillShare.Domain.Entities.UserAddOn", b =>
                {
                    b.HasOne("SkillShare.Domain.Entities.AddOn", "AddOn")
                        .WithMany()
